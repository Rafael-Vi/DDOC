          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo $_GET['table'];?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1"  class="table table-bordered table-striped">
                  <form class="myForm" method='POST' action='./include/functions/SQLfunctions.inc.php'>
                  <?php dataTable(); ?>
                  </form>
                  <ul class="pagination">
...
<script>
    function confirmSubmit(event, action) {
        ...
        if(action != "insert"){
          ...
          var message = "Are you sure you want to " + action + " into this table?";
        }
...
$(function () {
  $("#example1").DataTable({
    "responsive": true,
    "lengthChange": true, // Allow table length change
    "autoWidth": true, // Enable automatic column width calculation
    "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"], // Removed the reload button
