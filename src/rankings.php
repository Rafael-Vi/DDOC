...
<body class="h-full flex">
  <?php echoLoadScreen(); ?>    <?php
    ...
    <div class="h-32 text-center sm:text-start w-full p-10 font-bold text-4xl text-white sticky top-0 flex items-center justify-left gap-8 backdrop-blur-md bg-gray-900">
