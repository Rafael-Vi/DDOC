    ...
    <div class="flex flex-col h-full w-full p-10">
        ...
        <div class="overflow-y-auto h-96 flex flex-col items-center bg-gray-800">
            <div class="flex w-full text-center justify-center bg-gray-800 p-4 text-lg text-white border-b-2 border-gray-900 items-center">
                ...
                <div class="ubuntu-bold w-2/6">Person who posted it</div> <!-- Person who posted it -->
            </div>
            <div class="h-full overflow-y-auto w-full">
                <?php 
                $rank = rand(1, 100); // Random rank between 1 and 100
                $likes = rand(1, 1000); // Random likes between 1 and 1000
                $poster = "user" . rand(1, 100); // Random user name between user1 and user100
                
                echoRankAcc($rank, $likes, $poster);
                echoRankAcc($rank, $likes, $poster);
                echoRankAcc($rank, $likes, $poster);
                ?>
            </div>
