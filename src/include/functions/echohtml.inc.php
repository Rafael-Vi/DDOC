<?php
    ...
    function echoUserPosts($post) {
        ...
        echo '<button src="https://cdn-icons-png.flaticon.com/512/5400/5400852.png" onclick="showMyModal(\'' . addslashes($post['post_id']) . '\', \'' . addslashes($post['caption']) . '\')" class="edit-post absolute top-0 right-0 m-2 bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded" data-id="' . urlencode($post['post_id']) . '" style="visibility: hidden;">Edit</button>';
        echo '</div>';  
    }
