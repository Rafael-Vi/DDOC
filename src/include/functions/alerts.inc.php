...
function validRegisterAl(){
    ...
    echo '<div class="bg-green-100 p-5 w-1/2 center top-8 fixed rounded-lg left-1/2 transform -translate-x-1/2">';
...
function mySQLerror($error){
    echo '<div class="bg-red-100 p-5 w-1/2 center top-8 fixed rounded-lg left-1/2 transform -translate-x-1/2">';
    echo '  <div class="flex space-x-3">';
