...
function validRegisterAl(){
    ...
    echo '<div class="bg-green-100 p-5 w-1/2 absolute top-8 left-1/2 transform -translate-x-1/2 rounded-lg">';
...
function mySQLerror($error){
    echo '<div class="bg-red-100 p-5 w-1/2 absolute top-8 left-1/2 transform -translate-x-1/2 rounded-lg">';
    echo '  <div class="flex space-x-3">';
