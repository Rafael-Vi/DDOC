...
<div class="flip-container">
    <div class="flipper" id="flipper">
        <div class="front">
            ...
            <a class="flipbutton justify-center flex mt-4 select-none text-warning" id="loginButton" href="#">Create my account →</a>
        </div>
        ...
        <div class="back">
            ...
            <form id="registerForm" method="post" class="space-y-3">
                <div class="space-y-2">
                    <input type="text" id="usernameR" name="usernameR" placeholder="Username" minlength="4" maxlength="15" required class="bg-gray-200 select-none w-full px-4 py-2 border border-gray-300 text-black rounded-md mb-2 mt-6 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent">
            ...
            <a class="flipbutton justify-center flex mt-4 select-none text-warning" id="registerButton" href="#">Login to my account</a>
        </div>
    </div>
</div>
