...
<div class="fixed inset-0 flex-row">
    <div class="fixed inset-0 z-50 bg-gray-900 flex items-center justify-center flex-col">
      ...
      <h1 class="ubuntu-bold text-3xl text-white p-2 rounded">Sorry, no theme is available</h1>
      <h1 class="ubuntu-semibold text-xl text-white rounded">Come back later ;)</h1>
    </div>
</div>
