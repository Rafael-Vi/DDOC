...
<head>
    ...
    <link rel="stylesheet" href="/src/css/errorPages.css">    
    ...
    <title>Não existe esse post!!!</title>
</head>
...
<div class="fixed inset-0 flex-row">
    <div class="fixed inset-0 z-50 bg-gray-800 flex items-center justify-center flex-col">
      ...
      <h1 class="ubuntu-bold text-2xl sm:text-4xl text-white p-2 rounded">Não existe esse post</h1>
