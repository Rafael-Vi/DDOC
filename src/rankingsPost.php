...
<?php
  require "include/functions/checkThemeVar.inc.php";
    ...
    <div class="h-full w-full p-10">
      <div class="flex flex-col h-full w-full p-10">
        <div class="flex flex-col w-full p-10 sticky">
          ...
          <?php
            global $arrConfig;
            $podium = getPodium(2, "PostRank", $GLOBALS['theme_id'] );?>
            ...
            <?php $podium = getPodium(1, "PostRank", $GLOBALS['theme_id']); ?>
            <div class="flex flex-col items-center mt-auto">
                <?php if ($podium): ?>
                    <h1 class="mb-2"><?php echo $podium['NameOfThePost']; ?></h1>
            ...
            <?php $podium = getPodium(3, "PostRank", $GLOBALS['theme_id']); ?>
            <div class="flex flex-col items-center mt-auto">
                <?php if ($podium): ?>
                    <h1 class="mb-2"><?php echo $podium['NameOfThePost']; ?></h1>
        ...
        <div class="overflow-y-auto h-96 flex flex-col items-center bg-gray-800 ">
          <div class="flex w-full text-center justify-center bg-gray-800 p-4 text-lg text-white border-b-2 border-gray-900 items-center">
            ...
            <div class="ubuntu-bold w-1/6">Post content</div> <!-- Image of the post -->
          ...
          <?php 
            getRankingPost($GLOBALS['theme_id']);
          ?>
          </div>
          <!-- End of post div -->
      </div>
