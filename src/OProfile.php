      ...
      <div class="flex float-end h-32 text-white lg:h-64 mt-8 w-full">
        <div class="h-full w-full mt-0 md:mt-8 mb-4">
          ...
          <div class="flex justify-center">
            <a href="/src/mensagens' . $_GET['userid'] . '" class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded m-4">
            Mensagem
            </a>
            <button class="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded m-4 w-24 h-12" id="follow-button" onclick="followCheck()">
            Seguir
            </button>
          </div>
          ';
