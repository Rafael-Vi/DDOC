...
<body class="h-full flex">
    ...
    <h1 class="  h-32 text-white text-white text-white border text-center sm:text-start border-black w-full p-10 font-bold text-4xl shadow-md shadow-amber-600 bg-gray-800 sticky top-0">
      Publicar Post
    </h1>
