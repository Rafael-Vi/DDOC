...
<div class="flex flex-col items-center w-full sm:w-3/5 overflow-y-auto">
  ...
  <textarea id="post-title" name="post-title" required class="rounded-lg px-4 py-2  text-ddark-neutral w-full" maxlength="255"></textarea><br>
  <label for="post-type" class="text-ddark-neutral font-bold text-left float-left">Tipo:</label>
  <select id="post-type" name="post-type" required class="rounded-lg px-4 py-2  text-ddark-neutral mb-4 w-full">
  ...
  <input type="file" id="file-input" name="file-input" class="rounded-lg  text-ddark-neutral mb-4 w-full">
  <input type="text" id="post-theme" name="post-theme" disabled class="rounded-lg  text-ddark-neutral p-2 w-full" value="Tema: <?php echo $_SESSION['themes'][0]['theme']; ?>">
  ...
  <?php
    ...
    <h2 class="text-3xl font-bold  rounded-lg p-8 text-ddark-neutral gap-3">
