...
<div class="flex flex-col items-center w-full sm:w-3/5">
    <div class="flex flex-col items-center">
        <img src="<?php echo $arrConfig['url_assets'] . 'images/'?>" alt="Thumbnail" class="rounded-sm w-auto h-82 lg:h-72 mt-4 mr-10 lg:ml-3/5 sm:mr-8 lg:mr-3/5 object-contain max-w-[30vh]" id="profile-picture">
    </div>
