      ...
      <div class="modal-box">
        <form method="dialog">
          ...
          <div class="form-control mt-4 flex flex-row"></div>
            <button class="btn flex-initial btn-warning text-orange-500" onclick="saveReport()">Report</button>
            <button class="btn btn-outline ml-2 flex-initial btn-error text-red-700" onclick="cancelReport()">Cancelar</button>
          </div>
        </form>
      </div>
    </dialog>
