...
<body class="h-full flex">
  ...
  <div class="absolute md:flex md:flex-col md:top-0 md:left-0 md:w-1/5 md:bg-white md:h-full md:border-r hidden md:rounded-lg md:shadow-xl z-40">
    <div class="overflow-y-auto overflow-x-hidden flex-grow">
      <ul class="flex flex-col py-4 space-y-1">
        ...
        <li class="px-4 py-2">
          <a href="#" id="logout-button" style="color: black" onclick="openLogout()">Logout</a>
        </li>
      </ul>
    </div>
  </div>
  ...
  <div role="alert" class="hidden rounded-xl border border-gray-100 bg-white p-4 z-20 flex justify-center items-center" id="logout-div">
    <div class="flex items-start gap-4">
      ...
      <button class="text-gray-500 transition hover:text-gray-600" onclick=closeLogout()>
