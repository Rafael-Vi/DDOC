          ...
          <table className="table-auto overflow-scroll md:overflow-auto w-full text-left font-inter border ">
            <thead className="rounded-lg text-base text-white font-semibold w-full">
              <tr className="bg-[#222E3A]/[6%]">
                <th className="py-3 px-3 text-[#212B36] sm:text-base ubuntu-bold whitespace-nowrap">
                  ID
                </th>
                <th className="py-3 px-3 text-[#212B36] sm:text-base ubuntu-bold whitespace-nowrap">
                  Category
                </th>
                <th className="py-3 px-3  justify-center gap-1 text-[#212B36] sm:text-base ubuntu-bold whitespace-nowrap">
                  Company
                </th>
                <th className="py-3 px-3 text-[#212B36] sm:text-base ubuntu-bold whitespace-nowrap">
                  Product
                ...
                <th className="flex items-center py-3 px-3 text-[#212B36] sm:text-base ubuntu-bold whitespace-nowrap gap-1">
                  Price
                </th>
              </tr>
            </thead>
